...
<div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Project PBKK</h2>
      <p class="mt-6 text-lg leading-8 text-gray-300">Ini adalah sebuah Project latihan Laravel.</p>
    </div>
    <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
        <a href="#">Laravel <span aria-hidden="true">&rarr;</span></a>
        <a href="#">phpmyadmin <span aria-hidden="true">&rarr;</span></a>
        <a href="#">5025221301 <span aria-hidden="true">&rarr;</span></a>
        <a href="#">Muhammad Farras Arif Fadhila <span aria-hidden="true">&rarr;</span></a>
      </div>
